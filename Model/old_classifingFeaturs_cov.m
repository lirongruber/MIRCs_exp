...
for c=1:size(class,1)
    ...
    for t=1:size(class,2)
        ...
        if ~isempty(currT)
            ...
            figure(13) % xcov speed+number of inforec
            subplot(2,5,c)
            if size(currT.numOfinfoRec,2)>1
                [r,lags] = xcov(currT.targetSpeed(1:size(currT.numOfinfoRec,2)),currT.numOfinfoRec,'biased');
            ...
            subplot(2,5,c+5)
            if size(currT.numOfinfoRec,2)>1
                [r,lags] = xcov(flip(currT.targetSpeed(1:size(currT.numOfinfoRec,2))),flip(currT.numOfinfoRec),'biased');
            ...
            figure(16) % xcov amp+number of inforec
            subplot(2,5,c)
            if size(currT.numOfinfoRec,2)>1
                [r,lags] = xcov(currT.ampFixation(1:size(currT.numOfinfoRec,2)),currT.numOfinfoRec,'biased');
            ...
            subplot(2,5,c+5)
            if size(currT.numOfinfoRec,2)>1
                [r,lags] = xcov(flip(currT.ampFixation(1:size(currT.numOfinfoRec,2))),flip(currT.numOfinfoRec),'biased');
            ...
            figure(17) % xcov dist+number of inforec
            subplot(2,5,c)
            if size(currT.numOfinfoRec,2)>1
                [r,lags] = xcov(currT.distFixation(1:size(currT.numOfinfoRec,2)),currT.numOfinfoRec,'biased');
            ...
            subplot(2,5,c+5)
            if size(currT.numOfinfoRec,2)>1
                [r,lags] = xcov(flip(currT.distFixation(1:size(currT.numOfinfoRec,2))),flip(currT.numOfinfoRec),'biased');
            ...
            figure(23) % xcov speed+mean info per rec
            subplot(2,5,c)
            if size(currT.meanInfoPerRec,2)>1
                [r,lags] = xcov(currT.targetSpeed(1:size(currT.meanInfoPerRec,2)),currT.meanInfoPerRec,'biased');
            ...
            subplot(2,5,c+5)
            if size(currT.meanInfoPerRec,2)>1
                [r,lags] = xcov(flip(currT.targetSpeed(1:size(currT.meanInfoPerRec,2))),flip(currT.meanInfoPerRec),'biased');
            ...
            figure(26) % xcov amp+mean info per rec
            subplot(2,5,c)
            if size(currT.meanInfoPerRec,2)>1
                [r,lags] = xcov(currT.ampFixation(1:size(currT.meanInfoPerRec,2)),currT.meanInfoPerRec,'biased');
            ...
            subplot(2,5,c+5)
            if size(currT.meanInfoPerRec,2)>1
                [r,lags] = xcov(flip(currT.ampFixation(1:size(currT.meanInfoPerRec,2))),flip(currT.meanInfoPerRec),'biased');
            ...
            figure(27) % xcov dist+mean info per rec
            subplot(2,5,c)
            if size(currT.meanInfoPerRec,2)>1
                [r,lags] = xcov(currT.distFixation(1:size(currT.meanInfoPerRec,2)),currT.meanInfoPerRec,'biased');
            ...
            subplot(2,5,c+5)
            if size(currT.meanInfoPerRec,2)>1
                [r,lags] = xcov(flip(currT.distFixation(1:size(currT.meanInfoPerRec,2))),flip(currT.meanInfoPerRec),'biased');

...
for i=1:length(subjects)
    ...
    hold on
    bar(i*2,mean(trial(i).num_of_sacc_per_sec),'FaceColor',[0 220 220]./255,'EdgeColor',[0 0 0],'FaceAlpha',.5);
    ...
    bar(i*2,currmean,'FaceColor',[0 220 220]./255,'EdgeColor',[0 0 0],'FaceAlpha',.5);
    hold on
    errorbar(i*2,currmean,ste(f_curr_drifts_vel_deg2sec),'.','Color','b','LineWidth',2);

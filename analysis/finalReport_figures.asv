...
for i=1:size(paths1,2)
    ...
    set(gca, 'XTick', 1:3, 'XTickLabel', methods,'Fontsize',15);title('First trials of each image','Fontsize',20);ylabel('Recognition Rates','Fontsize',20)
end
text(0.6,0.32, '10x10', 'FontSize', 15)
text(1.6,0.87, '10x10', 'FontSize', 15)
text(-1,1.05,'a', 'FontSize', 30)

for i=1:size(paths2,2)
    figure(1)
    load(paths2{i});
    %recognitions
    subplot(1,2,2)
